...
public class ReadExcel {
    ...
    public List<School> readExcel(String path) throws IOException {
    ...
    private List<School> readXlsx(String path) throws IOException {
    ...
    private List<School> readXls(String path) throws IOException {
        System.out.println(Common.PROCESSING + path);
        InputStream is = new FileInputStream(path);
